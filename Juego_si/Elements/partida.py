...
from Elements.bot_aleatorio import *
from Elements.bot_estrategico import *
from Elements.cartas import *
from Elements.envido import *
...
def crear_oponente(tipo_oponente: str, nombre_oponente: str) -> dict:
    ...
    oponentes = {
        "Jugador Aleatorio": crear_bot_aleatorio,
        "Jugador Estratégico": crear_bot_estrategico 
    }
